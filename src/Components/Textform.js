...
export default function TextForm(props) 
  ...
  return (
    <>
              ...
              <button className="btn btn-primary mx-1 my-1" onClick={handleConvertToUppercase}>Convert to Uppercase</button>
              <button className="btn btn-primary mx-1 my-1" onClick={handleConvertToLowercase}>Convert to Lowercase</button>
              <button className="btn btn-primary mx-1 my-1" onClick={handleConvertToClear}>Clear Text</button>
